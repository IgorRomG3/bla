...
Blog.getInitialProps = async function() {
    ...
    if(PORT !== undefined) {
      h1Data = `localhost:${PORT}/static/data/h1.json`;
      singleData = `localhost:${PORT}/static/data/blog-single.json`;
      categoriesData = `localhost:${PORT}/static/data/blog-categories.json`;
    }else {
